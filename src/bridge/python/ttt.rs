...
use crate::core::env::{GameEnv, Player, TicTacToeEnv, TTT_ACTION_SPACE_SIZE};
use crate::core::mcts::{GumbelConfig, GumbelMCTS};
...
pub fn run_ttt_self_play_with_predictor(
    ...
    let episodes: Vec<GameEpisode> =
        crate::pipeline::self_play::run_batch_self_play(&evaluator, &cfg, num_games, TicTacToeEnv::new);
