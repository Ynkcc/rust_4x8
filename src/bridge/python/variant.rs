...
#[cfg(feature = "pyo3")]
use crate::core::env::{
    ACTION_SPACE_SIZE, RESNET_BOARD_CHANNELS, BOARD_COLS, BOARD_ROWS, GAME4X4_ACTION_SPACE_SIZE,
    GAME4X4_RESNET_BOARD_CHANNELS, GAME4X4_BOARD_COLS, GAME4X4_BOARD_ROWS, GAME4X4_RESNET_SCALAR_FEATURE_COUNT,
    MINI_ACTION_SPACE_SIZE, MINI_RESNET_BOARD_CHANNELS, MINI_BOARD_COLS, MINI_BOARD_ROWS,
    MINI_RESNET_SCALAR_FEATURE_COUNT, RESNET_SCALAR_FEATURE_COUNT, TTT_ACTION_SPACE_SIZE, TTT_RESNET_BOARD_CHANNELS,
    TTT_BOARD_COLS, TTT_BOARD_ROWS, TTT_RESNET_SCALAR_FEATURE_COUNT,
};
...
impl SelfPlayVariant {
    ...
    pub fn board_channels(self) -> usize {
        match self {
            Self::Dark4x8 => RESNET_BOARD_CHANNELS,
            Self::Mini4x2 => MINI_RESNET_BOARD_CHANNELS,
            Self::Game4x4 => GAME4X4_RESNET_BOARD_CHANNELS,
            Self::Ttt => TTT_RESNET_BOARD_CHANNELS,
        }
    }
    ...
    pub fn scalar_feature_count(self) -> usize {
        match self {
            Self::Dark4x8 => RESNET_SCALAR_FEATURE_COUNT,
            Self::Mini4x2 => MINI_RESNET_SCALAR_FEATURE_COUNT,
            Self::Game4x4 => GAME4X4_RESNET_SCALAR_FEATURE_COUNT,
            Self::Ttt => TTT_RESNET_SCALAR_FEATURE_COUNT,
        }
    }
